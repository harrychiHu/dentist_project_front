      ...
      <div class="about_wrap section">
        ...
        <div class="about_card">
          <div class="card">
            <h2>診所介紹</h2>
            <p>
              喜樂芽牙醫診所是一對喜愛宜蘭的台北夫妻醫生來此設立的。我們擁有專業和細心的醫生、以及親切又活潑的助理和全新的醫療儀器設備；舒適乾淨的看診環境，讓每一位病患不只解決口腔內的問題，心理上也有所撫慰
            </p>
          </div>
          <div class="card">
            <h2>診所理念</h2>
            <p>
              我們希望透過醫師的專業判斷與療程計畫來幫助每位病患，解決疑難雜症和指導正確的牙醫保健觀念，讓人們重拾健康和自信的笑容
            </p>
          </div>
        </div>
      </div>
