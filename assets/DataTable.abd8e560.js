...
`,[M("pagination-prefix",`
 ...
 `)]),Ve("disabled",[L("hover",Kt,Ut),q("&:hover",Kt,Ut),q("&:active",`
...
`,[de("splitor",`
 ...
 `),Ve("checked",{color:"var(--n-button-text-color-hover)"})]),L("focus",[q("&:not(:active)",[de("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),L("checked",`
 ...
 display: flex;
 flex-direction: column;
 `),L("flex-height",[q(">",[M("data-table-wrapper",[q(">",[M("data-table-base-table",`
 display: flex;
 flex-direction: column;
 flex-grow: 1;
 ...
 `,[L("striped","background-color: var(--n-merged-td-color-striped);",[M("data-table-td","background-color: var(--n-merged-td-color-striped);")]),Ve("summary",[q("&:hover","background-color: var(--n-merged-td-color-hover);",[M("data-table-td","background-color: var(--n-merged-td-color-hover);")])])]),M("data-table-th",`
 ...
 `,[L("filterable",{paddingRight:"36px"}),jt,L("selection",`
 padding: 0;
 text-align: center;
 line-height: 0;
 z-index: 3;
 ...
 white-space: nowrap;
 max-width: 100%;
 `),L("hover",{backgroundColor:"var(--n-merged-th-color-hover)"}),L("sortable",{cursor:"pointer"},[de("ellipsis",{maxWidth:"calc(100% - 18px)"}),q("&:hover",{backgroundColor:"var(--n-merged-th-color-hover)"})]),M("data-table-sorter",`
 ...
 transition: color .3s var(--n-bezier);
 `,[M("base-icon","transition: transform .3s var(--n-bezier)"),L("desc",[M("base-icon",{transform:"rotate(0deg)"})]),L("asc",[M("base-icon",{transform:"rotate(-180deg)"})]),L("asc, desc",{color:"var(--n-th-icon-color-active)"})]),M("data-table-filter",`
 position: absolute;
 z-index: auto;
 right: 0;
 width: 36px;
 ...
 background-color: var(--n-merged-th-color);
 `),L("hover",{backgroundColor:"var(--n-merged-td-color-hover)"}),de("ellipsis",`
 display: inline-block;
 text-overflow: ellipsis;
 overflow: hidden;
 white-space: nowrap;
 ...
 `,[L("hide",{opacity:0})]),de("pagination",`
 ...
 pointer-events: none;
 `)]),L("single-column",[M("data-table-td",{borderBottom:"0 solid var(--n-merged-border-color)"},[q("&::after, &::before",{bottom:"0 !important"})])]),Ve("single-line",[M("data-table-th",{borderRight:"1px solid var(--n-merged-border-color)"},[L("last",{borderRight:"0 solid var(--n-merged-border-color)"})]),M("data-table-td",{borderRight:"1px solid var(--n-merged-border-color)"},[L("last-col",{borderRight:"0 solid var(--n-merged-border-color)"})])]),L("bordered",[M("data-table-wrapper",`
 border: 1px solid var(--n-merged-border-color);
 border-bottom-left-radius: var(--n-border-radius);
 border-bottom-right-radius: var(--n-border-radius);
 overflow: hidden;
 `)]),M("data-table-base-table",[L("transition-disabled",[M("data-table-th",[q("&::after, &::before",{transition:"none"})]),M("data-table-td",[q("&::after, &::before",{transition:"none"})])])]),L("bottom-bordered",[M("data-table-td",[L("last-row",{borderBottom:"1px solid var(--n-merged-border-color)"})])]),M("data-table-table",`
 ...
 transition: box-shadow .2s var(--n-bezier);
 left: -36px;
 `)])]}const xn=Object.assign(Object.assign({},ke.props),{pagination:{type:[Object,Boolean],default:!1},paginateSinglePage:{type:Boolean,default:!0},minHeight:[Number,String],maxHeight:[Number,String],columns:{type:Array,default:()=>[]},rowClassName:[String,Function],rowProps:Function,rowKey:Function,summary:[Function],data:{type:Array,default:()=>[]},loading:Boolean,bordered:{type:Boolean,default:void 0},bottomBordered:{type:Boolean,default:void 0},striped:Boolean,scrollX:[Number,String],defaultCheckedRowKeys:{type:Array,default:()=>[]},checkedRowKeys:Array,singleLine:{type:Boolean,default:!0},singleColumn:Boolean,size:{type:String,default:"medium"},remote:Boolean,defaultExpandedRowKeys:{type:Array,default:[]},defaultExpandAll:Boolean,expandedRowKeys:Array,virtualScroll:Boolean,tableLayout:{type:String,default:"auto"},allowCheckingNotLoaded:Boolean,cascade:{type:Boolean,default:!0},childrenKey:{type:String,default:"children"},indent:{type:Number,default:16},flexHeight:Boolean,paginationBehaviorOnFilter:{type:String,default:"current"},renderCell:Function,onLoad:Function,"onUpdate:page":[Function,Array],onUpdatePage:[Function,Array],"onUpdate:pageSize":[Function,Array],onUpdatePageSize:[Function,Array],"onUpdate:sorter":[Function,Array],onUpdateSorter:[Function,Array],"onUpdate:filters":[Function,Array],onUpdateFilters:[Function,Array],"onUpdate:checkedRowKeys":[Function,Array],onUpdateCheckedRowKeys:[Function,Array],"onUpdate:expandedRowKeys":[Function,Array],onUpdateExpandedRowKeys:[Function,Array],onScroll:Function,onPageChange:[Function,Array],onPageSizeChange:[Function,Array],onSorterChange:[Function,Array],onFiltersChange:[Function,Array],onCheckedRowKeysChange:[Function,Array]}),Rn=oe({name:"DataTable",alias:["AdvancedTable"],props:xn,setup(e,{slots:t}){const{mergedBorderedRef:o,mergedClsPrefixRef:r,inlineThemeDisabled:a}=Le(e),i=w(()=>{const{bottomBordered:K}=e;return o.value?!1:K!==void 0?K:!0}),d=ke("DataTable","-data-table",mn,$r,e,r),u=N(null),s=N("body");Yo(()=>{s.value="body"});const f=N(null),{rowsRef:k,colsRef:p,dataRelatedColsRef:g,hasEllipsisRef:c}=vn(e),{treeMateRef:l,mergedCurrentPageRef:m,paginatedDataRef:b,rawPaginatedDataRef:R,selectionColumnRef:y,hoverKeyRef:B,mergedPaginationRef:U,mergedFilterStateRef:S,mergedSortStateRef:$,childTriggerColIndexRef:F,doUpdatePage:G,doUpdateFilters:C,deriveNextSorter:z,filter:O,filters:D,clearFilter:E,clearFilters:j,clearSorter:ee,page:X,sort:V}=fn(e,{dataRelatedColsRef:g}),{doCheckAll:se,doUncheckAll:h,doCheck:_,doUncheck:A,headerCheckboxDisabledRef:P,someRowsCheckedRef:Z,allRowsCheckedRef:te,mergedCheckedRowKeySetRef:ce,mergedInderminateRowKeySetRef:re}=dn(e,{selectionColumnRef:y,treeMateRef:l,paginatedDataRef:b}),{mergedExpandedRowKeysRef:ve,renderExpandRef:ne,doUpdateExpandedRowKeys:v}=pn(e,l),{handleTableBodyScroll:x,handleTableHeaderScroll:J,syncScrollState:pe,setHeaderScrollLeft:xe,leftActiveFixedColKeyRef:he,leftActiveFixedChildrenColKeysRef:Oe,rightActiveFixedColKeyRef:Ke,rightActiveFixedChildrenColKeysRef:me,leftFixedColumnsRef:ye,rightFixedColumnsRef:Be,fixedColumnLeftMapRef:Ue,fixedColumnRightMapRef:Ne}=hn(e,{scrollPartRef:s,bodyWidthRef:u,mainTableInstRef:f,mergedCurrentPageRef:m}),{localeRef:Ee}=Zt("DataTable"),we=w(()=>e.virtualScroll||e.flexHeight||e.maxHeight!==void 0||c.value?"fixed":e.tableLayout);pt(ze,{loadingKeySetRef:N(new Set),slots:t,indentRef:ie(e,"indent"),childTriggerColIndexRef:F,bodyWidthRef:u,componentId:Qo(),hoverKeyRef:B,mergedClsPrefixRef:r,mergedThemeRef:d,scrollXRef:w(()=>e.scrollX),rowsRef:k,colsRef:p,paginatedDataRef:b,leftActiveFixedColKeyRef:he,leftActiveFixedChildrenColKeysRef:Oe,rightActiveFixedColKeyRef:Ke,rightActiveFixedChildrenColKeysRef:me,leftFixedColumnsRef:ye,rightFixedColumnsRef:Be,fixedColumnLeftMapRef:Ue,fixedColumnRightMapRef:Ne,mergedCurrentPageRef:m,someRowsCheckedRef:Z,allRowsCheckedRef:te,mergedSortStateRef:$,mergedFilterStateRef:S,loadingRef:ie(e,"loading"),rowClassNameRef:ie(e,"rowClassName"),mergedCheckedRowKeySetRef:ce,mergedExpandedRowKeysRef:ve,mergedInderminateRowKeySetRef:re,localeRef:Ee,scrollPartRef:s,rowKeyRef:ie(e,"rowKey"),renderExpandRef:ne,summaryRef:ie(e,"summary"),virtualScrollRef:ie(e,"virtualScroll"),rowPropsRef:ie(e,"rowProps"),stripedRef:ie(e,"striped"),checkOptionsRef:w(()=>{const{value:K}=y;return K==null?void 0:K.options}),rawPaginatedDataRef:R,filterMenuCssVarsRef:w(()=>{const{self:{actionDividerColor:K,actionPadding:ae,actionButtonMargin:Q}}=d.value;return{"--n-action-padding":ae,"--n-action-button-margin":Q,"--n-action-divider-color":K}}),onLoadRef:ie(e,"onLoad"),mergedTableLayoutRef:we,maxHeightRef:ie(e,"maxHeight"),minHeightRef:ie(e,"minHeight"),flexHeightRef:ie(e,"flexHeight"),headerCheckboxDisabledRef:P,paginationBehaviorOnFilterRef:ie(e,"paginationBehaviorOnFilter"),syncScrollState:pe,doUpdatePage:G,doUpdateFilters:C,deriveNextSorter:z,doCheck:_,doUncheck:A,doCheckAll:se,doUncheckAll:h,doUpdateExpandedRowKeys:v,handleTableHeaderScroll:J,handleTableBodyScroll:x,setHeaderScrollLeft:xe,renderCell:ie(e,"renderCell")});const T={filter:O,filters:D,clearFilters:j,clearSorter:ee,page:X,sort:V,clearFilter:E,scrollTo:(K,ae)=>{var Q;(Q=f.value)===null||Q===void 0||Q.scrollTo(K,ae)}},I=w(()=>{const{size:K}=e,{common:{cubicBezierEaseInOut:ae},self:{borderColor:Q,tdColorHover:ue,thColor:Ce,thColorHover:De,tdColor:Te,tdTextColor:_e,thTextColor:We,thFontWeight:qe,thButtonColorHover:$e,thIconColor:je,thIconColorActive:Ie,filterSize:Re,borderRadius:ge,lineHeight:be,tdColorModal:Qe,thColorModal:et,borderColorModal:tt,thColorHoverModal:ot,tdColorHoverModal:rt,borderColorPopover:nt,thColorPopover:at,tdColorPopover:it,tdColorHoverPopover:lt,thColorHoverPopover:vo,paginationMargin:po,emptyPadding:mo,boxShadowAfter:bo,boxShadowBefore:xo,sorterSize:yo,loadingColor:Co,loadingSize:wo,opacityLoading:Ro,tdColorStriped:So,tdColorStripedModal:ko,tdColorStripedPopover:Fo,[le("fontSize",K)]:Po,[le("thPadding",K)]:zo,[le("tdPadding",K)]:Mo}}=d.value;return{"--n-font-size":Po,"--n-th-padding":zo,"--n-td-padding":Mo,"--n-bezier":ae,"--n-border-radius":ge,"--n-line-height":be,"--n-border-color":Q,"--n-border-color-modal":tt,"--n-border-color-popover":nt,"--n-th-color":Ce,"--n-th-color-hover":De,"--n-th-color-modal":et,"--n-th-color-hover-modal":ot,"--n-th-color-popover":at,"--n-th-color-hover-popover":vo,"--n-td-color":Te,"--n-td-color-hover":ue,"--n-td-color-modal":Qe,"--n-td-color-hover-modal":rt,"--n-td-color-popover":it,"--n-td-color-hover-popover":lt,"--n-th-text-color":We,"--n-td-text-color":_e,"--n-th-font-weight":qe,"--n-th-button-color-hover":$e,"--n-th-icon-color":je,"--n-th-icon-color-active":Ie,"--n-filter-size":Re,"--n-pagination-margin":po,"--n-empty-padding":mo,"--n-box-shadow-before":xo,"--n-box-shadow-after":bo,"--n-sorter-size":yo,"--n-loading-size":wo,"--n-loading-color":Co,"--n-opacity-loading":Ro,"--n-td-color-striped":So,"--n-td-color-striped-modal":ko,"--n-td-color-striped-popover":Fo}}),Y=a?Xe("data-table",w(()=>e.size[0]),I,e):void 0,W=w(()=>{if(!e.pagination)return!1;if(e.paginateSinglePage)return!0;const K=U.value,{pageCount:ae}=K;return ae!==void 0?ae>1:K.itemCount&&K.pageSize&&K.itemCount>K.pageSize});return Object.assign({mainTableInstRef:f,mergedClsPrefix:r,mergedTheme:d,paginatedData:b,mergedBordered:o,mergedBottomBordered:i,mergedPagination:U,mergedShowPagination:W,cssVars:a?void 0:I,themeClass:Y==null?void 0:Y.themeClass,onRender:Y==null?void 0:Y.onRender},T)},render(){const{mergedClsPrefix:e,themeClass:t,onRender:o}=this;return o==null||o(),n("div",{class:[`${e}-data-table`,t,{[`${e}-data-table--bordered`]:this.mergedBordered,[`${e}-data-table--bottom-bordered`]:this.mergedBottomBordered,[`${e}-data-table--single-line`]:this.singleLine,[`${e}-data-table--single-column`]:this.singleColumn,[`${e}-data-table--loading`]:this.loading,[`${e}-data-table--flex-height`]:this.flexHeight}],style:this.cssVars},n("div",{class:`${e}-data-table-wrapper`},n(ln,{ref:"mainTableInstRef"})),this.mergedShowPagination?n("div",{class:`${e}-data-table__pagination`},n(Fr,Object.assign({theme:this.mergedTheme.peers.Pagination,themeOverrides:this.mergedTheme.peerOverrides.Pagination,disabled:this.loading},this.mergedPagination))):null,n(er,{name:"fade-in-scale-up-transition"},{default:()=>this.loading?n(oo,{clsPrefix:e,strokeWidth:20}):null}))}});export{Rn as _};
