import{j as w,k as m,l,m as H,n as v,p as k,q as j,s as B,v as E,x as N,y as x,z as S,A as _,B as V,C as I,D as $,E as A,G as O,H as K,I as M,J as D,o as q,c as F,a,b as u,w as b,K as G,N as J,L as f}from"./index.d9d4ca77.js";import{N as U}from"./Image.f3833513.js";const Q={fontWeightActive:"400"},X=e=>{const{fontSize:n,textColor3:t,textColor2:r,borderRadius:s,buttonColor2Hover:o,buttonColor2Pressed:i}=e;return Object.assign(Object.assign({},Q),{fontSize:n,itemLineHeight:"1.25",itemTextColor:t,itemTextColorHover:r,itemTextColorPressed:r,itemTextColorActive:r,itemBorderRadius:s,itemColorHover:o,itemColorPressed:i,separatorColor:t})},Y={name:"Breadcrumb",common:w,self:X},Z=Y,W=m("breadcrumb",`
 white-space: nowrap;
 cursor: default;
